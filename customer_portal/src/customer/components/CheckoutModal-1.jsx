            ...
            <div className="space-y-3">
              ...
              {checkoutData.method === "Deliver" && (
                <>
                  ...
                  <input
                    type="text"
                    placeholder="Address"
                    className="w-full p-3 bg-gray-50 rounded-xl text-[11px] outline-none relative z-10"
              ...
              {checkoutData.payment === "GCash" && (
                <p className="text-[9px] text-gray-500 mt-2">
                  Please enter your GCash number for payment processing.
                </p>
              )}
