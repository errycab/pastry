        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-14">
              <StatCard title="Total Revenue" value={peso(totalRevenue)} sub={`from ${salesOrders.length} completed orders`} icon={TrendingUp} accent="bg-gradient-to-br from-[#d4af37] to-[#b09c4a]" />
