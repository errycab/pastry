              ...
              return (
                ...
                >
                  ...
                  <div className="border-t pt-3 flex justify-between font-semibold">
                    <span>Total</span>
                    <span className={isCancelled ? "text-red-400 line-through" : "text-[#d4af37]"}>
                  ...
                  {/* ACTION AREA */}
                  {isCancelled ? (
                    <div className="mt-4 rounded-full border border-red-200 bg-red-50 px-4 py-2 text-sm text-red-400 text-center">
